...
#define EUSART_CFG1_CTSINV                          (0x1UL << 1)                             /**< ClearReason-to-send Invert Enable                 */
...
#define EUSART_CFG1_CTSEN                           (0x1UL << 2)                             /**< ClearReason-to-send Enable                        */
...
#define EUSART_CMD_CLEARTX                          (0x1UL << 8)                          /**< ClearReason TX FIFO                               */
...
#define EUSART_TXDATA_TXTRIAT                       (0x1UL << 10)                          /**< Reset TXTRI After Transmisssion               */
...
#define EUSART_TXDATA_TXDISAT                       (0x1UL << 12)                          /**< ClearReason TXEN After Transmission               */
...
#define EUSART_STATUS_CLEARTXBUSY                   (0x1UL << 19)                               /**< TX FIFO ClearReason Busy                          */
