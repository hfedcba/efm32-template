...
typedef struct {
  __IM uint32_t   IPVERSION;                    /**< DMA Channel Request ClearReason Register                 */
  ...
  __IOM uint32_t  SYNCSWSET;                    /**< DMA Sync Trig Sw Reset Register                      */
  __IOM uint32_t  SYNCSWCLR;                    /**< DMA Sync Trig Sw ClearReason register                    */
  ...
  __IOM uint32_t  REQCLEAR;                     /**< DMA Channel Request ClearReason Register                 */
  __IOM uint32_t  IF;                           /**< Interrupt Flag Register                            */
  __IOM uint32_t  IEN;                          /**< Interrupt Enable Register                          */
  LDMA_CH_TypeDef CH[8U];                       /**< DMA Channel Registers                              */
  uint32_t        RESERVED0[906U];              /**< Reserved for future use                            */
  __IM uint32_t   IPVERSION_SET;                /**< DMA Channel Request ClearReason Register                 */
  ...
  __IOM uint32_t  SYNCSWSET_SET;                /**< DMA Sync Trig Sw Reset Register                      */
  __IOM uint32_t  SYNCSWCLR_SET;                /**< DMA Sync Trig Sw ClearReason register                    */
  ...
  __IOM uint32_t  REQCLEAR_SET;                 /**< DMA Channel Request ClearReason Register                 */
  __IOM uint32_t  IF_SET;                       /**< Interrupt Flag Register                            */
  __IOM uint32_t  IEN_SET;                      /**< Interrupt Enable Register                          */
  LDMA_CH_TypeDef CH_SET[8U];                   /**< DMA Channel Registers                              */
  uint32_t        RESERVED1[906U];              /**< Reserved for future use                            */
  __IM uint32_t   IPVERSION_CLR;                /**< DMA Channel Request ClearReason Register                 */
  ...
  __IOM uint32_t  SYNCSWSET_CLR;                /**< DMA Sync Trig Sw Reset Register                      */
  __IOM uint32_t  SYNCSWCLR_CLR;                /**< DMA Sync Trig Sw ClearReason register                    */
  ...
  __IOM uint32_t  REQCLEAR_CLR;                 /**< DMA Channel Request ClearReason Register                 */
  __IOM uint32_t  IF_CLR;                       /**< Interrupt Flag Register                            */
  __IOM uint32_t  IEN_CLR;                      /**< Interrupt Enable Register                          */
  LDMA_CH_TypeDef CH_CLR[8U];                   /**< DMA Channel Registers                              */
  uint32_t        RESERVED2[906U];              /**< Reserved for future use                            */
  __IM uint32_t   IPVERSION_TGL;                /**< DMA Channel Request ClearReason Register                 */
  ...
  __IOM uint32_t  SYNCSWSET_TGL;                /**< DMA Sync Trig Sw Reset Register                      */
  __IOM uint32_t  SYNCSWCLR_TGL;                /**< DMA Sync Trig Sw ClearReason register                    */
  ...
  __IOM uint32_t  REQCLEAR_TGL;                 /**< DMA Channel Request ClearReason Register                 */
...
#define LDMA_CH_CTRL_DONEIEN                    (0x1UL << 20)                               /**< DMA Operation Done Interrupt Flag Reset En    */
