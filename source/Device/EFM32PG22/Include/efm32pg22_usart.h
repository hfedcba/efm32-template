...
#define USART_CMD_CLEARTX                       (0x1UL << 10)                           /**< ClearReason TX                                    */
...
#define USART_CMD_CLEARRX                       (0x1UL << 11)                           /**< ClearReason RX                                    */
...
#define USART_TXDATAX_TXTRIAT                   (0x1UL << 12)                           /**< Reset TXTRI After Transmission                */
...
#define USART_TXDATAX_TXDISAT                   (0x1UL << 14)                           /**< ClearReason TXEN After Transmission               */
...
#define USART_TXDOUBLEX_TXTRIAT0                (0x1UL << 12)                             /**< Reset TXTRI After Transmission                */
...
#define USART_TXDOUBLEX_TXDISAT0                (0x1UL << 14)                             /**< ClearReason TXEN After Transmission               */
...
#define USART_TXDOUBLEX_TXTRIAT1                (0x1UL << 28)                             /**< Reset TXTRI After Transmission                */
...
#define USART_TXDOUBLEX_TXDISAT1                (0x1UL << 30)                             /**< ClearReason TXEN After Transmission               */
