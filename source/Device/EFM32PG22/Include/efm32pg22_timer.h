...
typedef struct {
  ...
  __IOM uint32_t   DTFAULTC;                    /**< DTI Fault ClearReason Register                           */
  ...
  __IOM uint32_t   DTFAULTC_SET;                /**< DTI Fault ClearReason Register                           */
  ...
  __IOM uint32_t   DTFAULTC_CLR;                /**< DTI Fault ClearReason Register                           */
  ...
  __IOM uint32_t   DTFAULTC_TGL;                /**< DTI Fault ClearReason Register                           */
...
#define TIMER_CFG_DMACLRACT                        (0x1UL << 7)                              /**< DMA Request ClearReason on Active                 */
...
#define TIMER_DTFAULTC_DTPRS0FC                    (0x1UL << 0)                              /**< DTI PRS0 Fault ClearReason                        */
...
#define TIMER_DTFAULTC_DTPRS1FC                    (0x1UL << 1)                              /**< DTI PRS1 Fault ClearReason                        */
...
#define TIMER_DTFAULTC_DTDBGFC                     (0x1UL << 2)                              /**< DTI Debugger Fault ClearReason                    */
...
#define TIMER_DTFAULTC_DTLOCKUPFC                  (0x1UL << 3)                              /**< DTI Lockup Fault ClearReason                      */
...
#define TIMER_DTFAULTC_DTEM23FC                    (0x1UL << 4)                              /**< DTI EM23 Fault ClearReason                        */
