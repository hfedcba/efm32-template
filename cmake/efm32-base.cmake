...
while (NOT DEVICE_FOUND)
    if (EXISTS "${CMAKE_CURRENT_LIST_DIR}/../gecko-sdk/platform/Device/SiliconLabs/${TEMP_DEVICE}")
...
elseif (CPU_FAMILY_U STREQUAL "EFR32MG21" OR CPU_FAMILY_U STREQUAL "EFR32BG21"
        ...
        OR CPU_FAMILY_U STREQUAL "EFM32PG22")
...
# Build flags
set(CMAKE_C_FLAGS "-std=c11 ${COMMON_DEFINITIONS} ${CPU_FIX} --specs=nano.specs ${DEPFLAGS}")
set(CMAKE_CXX_FLAGS "-std=c++17 ${COMMON_DEFINITIONS} ${CPU_FIX} --specs=nano.specs ${DEPFLAGS}")
set(CMAKE_ASM_FLAGS "${COMMON_DEFINITIONS} -x assembler-with-cpp -DLOOP_ADDR=0x8000")

# Set default inclusions
set(LIBS ${LIBS} -lstdc++ -lgcc -lc -lm -lnosys)
