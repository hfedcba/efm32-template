...
# Set compiler paths
if (PLATFORM_WINDOWS)
    set(CMAKE_C_COMPILER ${COMPILER_PREFIX}arm-none-eabi-gcc.exe)
    set(CMAKE_CXX_COMPILER ${COMPILER_PREFIX}arm-none-eabi-g++.exe)
    set(CMAKE_ASM_COMPILER ${COMPILER_PREFIX}arm-none-eabi-g++.exe)
    ...
    set(IMAGE_TOOL ${CMAKE_SOURCE_DIR}/cmake/sensaru-g1-image-tool.exe)
